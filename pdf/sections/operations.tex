...
\begin{itemize}[leftmargin=1.5em]
  ...
  \texttt{raes-jax-celeba-kaggle-tpuv5e8-sitdh-s.ipynb}; bản này cố định biến
  ...
  \texttt{raes-jax-celeba-kaggle-tpuv5e8-sitdh-b.ipynb}. Bản này giữ toàn bộ
  fix Kaggle/JAX hiện có, chỉ đổi phần Stage 2 sang config \texttt{SiTDH-B},
  ...
  \texttt{raes-jax-celeba-kaggle-tpuv5e8-sitdh-b-resume.ipynb}. Notebook này
