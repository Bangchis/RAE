...
\begin{itemize}[leftmargin=1.5em]
  ...
  cũng mặc định bật \texttt{training.random\_flip=true}. Route TFDS cũ vẫn còn
  ...
  từ Hugging Face rồi export sang \texttt{ImageFolder} trước khi build Stage 1 stat, bật \texttt{training.random\_flip=true}, và đã bỏ override chẩn đoán
  ...
  \texttt{training.random\_flip=true}, và dùng
