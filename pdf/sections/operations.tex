...
\begin{itemize}[leftmargin=1.5em]
  ...
  \texttt{raes-jax-celeba-kaggle.ipynb} để giữ đúng flow clone repo, tạo
  \texttt{.venv} riêng bằng \texttt{uv}, rồi chạy các bước phụ thuộc package qua
  \texttt{uv run}.
  ...
  detector backend-native của JAX, đồng thời cũng giữ các bước JAX trong
  \texttt{.venv} riêng qua \texttt{uv run}, tự xóa cờ executable-stack mà
