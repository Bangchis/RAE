...
\begin{itemize}[leftmargin=1.5em]
  ...
  \item Nếu chạy trên Kaggle \texttt{TPU v5e-8}, dùng notebook
  \texttt{raes-jax-celeba-kaggle-tpuv5e8.ipynb}; notebook này cài \texttt{jax[tpu]}
  và kiểm tra \texttt{jax}/TPU bằng tiến trình Python mới để tránh notebook-kernel skew.
