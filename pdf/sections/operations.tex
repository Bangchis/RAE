...
\begin{itemize}[leftmargin=1.5em]
  ...
  reference stats sang detector backend-native của JAX, đồng thời cũng giữ các
  ...
  \texttt{jax}/TPU bằng tiến trình Python mới. Notebook này cũng đã bỏ override
  chẩn đoán \texttt{ema\_decay=0.99}, nên mặc định quay lại EMA chuẩn của config.
