...
\begin{itemize}[leftmargin=1.5em]
  ...
  \texttt{raes-jax-celeba-kaggle.ipynb} để giữ đúng flow clone repo, cài
  \texttt{uv}, chuẩn hóa dữ liệu, build stat và launch train.
  ...
  reference stats sang host CPU thay vì \texttt{cuda}, đồng thời kiểm tra
  \texttt{jax}/TPU bằng tiến trình Python mới để tránh lỗi circular import sau
  khi reinstall package ngay trong notebook.
