...
Trên Kaggle TPU, nên thêm \texttt{--set training.num\_workers=1} để backend
PyTorch loader vẫn tương thích với \texttt{persistent\_workers=True} mà không
\texttt{fork()} cả một pool worker lớn sau khi JAX đã khởi tạo runtime đa
luồng. Adapter cũng tự tắt backend TensorBoard summary writer trên Kaggle và
...
\texttt{--data-path /kaggle/working/celebahq256\_imgfolder/train}, còn
