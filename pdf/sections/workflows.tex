...
CelebA Stage 2 là \texttt{DiTDH-S}, sync dependency của repo vào
...
Nếu đã có thư mục run Orbax của \texttt{DiTDH-B} và cần train tiếp, dùng
notebook \texttt{raes-jax-celeba-kaggle-tpuv5e8-ditdh-b-resume.ipynb}. Notebook
...
\texttt{CelebA256\_DiTDH-B\_DINOv2-B\_jax\_tpuv5e8-*} mới nhất bên dưới
