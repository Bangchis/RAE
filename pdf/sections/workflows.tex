...
Nếu muốn giữ nguyên flow đó nhưng đổi Stage 2 sang biến thể \texttt{SiTDH-B},
dùng notebook \texttt{raes-jax-celeba-kaggle-tpuv5e8-sitdh-b.ipynb}. Notebook
này ghi config CelebA thành
\texttt{CelebA256\_SiTDH-B\_DINOv2-B\_jax\_tpuv5e8.yaml}, đổi encoder-side
\texttt{hidden\_size} sang \texttt{768}, đổi \texttt{num\_heads} sang
\texttt{12}, đặt tên run/project mặc định theo biến thể \texttt{SiTDH-B}, và
