...
\subsubsection{Notebook Kaggle cho TPU v5e-8}
...
và kiểm tra \texttt{jax}/TPU trong một tiến trình Python mới để tránh lỗi khi
vừa reinstall \texttt{jax}/\texttt{jaxlib} ngay trong notebook.
