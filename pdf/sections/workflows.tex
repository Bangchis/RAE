...
\begin{itemize}[leftmargin=1.5em]
  ...
  \item tải dataset Hugging Face \texttt{eurecom-ds/celeba-hq} rồi export thành \texttt{ImageFolder} \texttt{256x256};
...
dùng Hugging Face để tải \texttt{eurecom-ds/celeba-hq} vào cache cục bộ rồi
