...
\begin{itemize}[leftmargin=1.5em]
  ...
  \item cài môi trường bằng \texttt{uv};
...
\texttt{jax[tpu]}, chạy bước xác nhận TPU trong một tiến trình Python mới để
tránh lỗi circular import khi notebook vừa reinstall \texttt{jax}/\texttt{jaxlib},
giữ Stage 1 và Stage 2 ở TPU, còn FID và thống kê tham chiếu sẽ chạy trên host
CPU nhiều luồng.
