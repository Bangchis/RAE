...
\texttt{src\_jax/stage2\_runtime.py} & Train, sampling, load checkpoint PyTorch hoặc Orbax, JAX validation-loss integration, FID glue, wandb bridge \\
 ...
 \texttt{src\_jax/export\_celebahq\_hf.py} & Download \texttt{eurecom-ds/celeba-hq} từ Hugging Face rồi export thành cây \texttt{ImageFolder} cho pipeline JAX hiện tại \\
