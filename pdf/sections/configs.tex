...
\texttt{eval} & yes, một phần & no & no & no \\
\bottomrule
\end{longtable}
\end{center}
...
Đường JAX hiện dùng phần FID nhiều hơn phần validation loss. Nếu \texttt{fid\_ref}
là file \texttt{.npz} của repo cũ, adapter sẽ tự chuyển nó sang định dạng pickle
mà backend NNX hiểu được.
