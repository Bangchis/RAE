...
- `src_jax/export_celebahq_tfds.py` materializes TFDS `celeb_a_hq/256` into the `ImageFolder` layout still expected by the current JAX training pipeline; TFDS requires the official manual tar files under `--manual-dir`.
